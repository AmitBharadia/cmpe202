...
public class BuildOrder {
    ...
    public static Component getOrder()
    {
        ...
        ConcreteBurger b = new ConcreteBurger( "Burger Options" ) ;
        OrganicBison ob=new OrganicBison(b);
        halflb halflb=new halflb(ob);
        OnABun onABun=new OnABun(halflb);
        System.out.println("Price :" + onABun.getPrice());
        System.out.println("Description :" + onABun.getDescription());
